#!/usr/bin/env python3
"""
Скрипт для инкрементального обновления объединенных записей unified_houses_3
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Обновление объединенных записей unified_houses_3')
    parser.add_argument('--id', type=str, help='ID конкретной записи для обновления (ObjectId)')
    args = parser.parse_args()

    print("🔄 Начинаем инкрементальное обновление unified_houses_3...")
